...
(function() {
  var a, b, c, d, freq, freqs, frequencyBase, frequencyPerStep, gid, setFreq;
  ...
  setFreq = function(newFrequency) {
    var multiplier, _i, _len, _ref, _results, _synth;
    _ref = [a, b, c, d, synth];
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      _synth = _ref[_i];
      multiplier = freqs[_synth] || 1;
      _results.push(_synth.set({
  ...
  window.main = function($scope) {
    ...
    $scope.play = function(color) {
      var betterNote, diff, joshnstonMap, n, newFrequency, note, rgb, _k, _len2;
